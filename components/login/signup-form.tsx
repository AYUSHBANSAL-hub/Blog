...
const SignUpFormSection = () => {
  ...
  <h1 className="text-3xl sm:text-4xl font-semibold text-[#09090B]">
    Sign Up
  </h1>
  ...
  <form className="flex flex-col">
    <div className="flex flex-col gap-4 sm:gap-[16px]">
      ...
      <div className="flex flex-col gap-2">
        ...
        {/* Remember Me & Forgot */}
        <div className="flex flex-wrap sm:flex-nowrap items-center justify-between text-sm mt-2 gap-2">
      ...
      {/* Submit Button */}
      <div className="flex flex-col mt-[6px] gap-3">
        <Button className="w-full min-h-[40px] px-4 py-[10px] bg-[#09090B] text-neutral-50 mt-1 rounded-md flex items-center justify-center gap-2">
