    ...
    <div className="flex flex-col w-full items-center gap-10 pb-7 relative px-4 sm:px-6">
      <div className="w-full max-w-[1200px] h-auto md:h-[383.43px] rounded-[32px] overflow-hidden relative shadow-xl">
        <div className="relative w-full h-full">
          ...
          {/* Content */}
          <div className="relative flex flex-col items-center justify-center h-full px-4 sm:px-6 md:px-[80px] lg:px-[150px] py-10 md:py-16 z-10">
            <div className="flex flex-col items-center gap-6 sm:gap-8 md:gap-[43px] max-w-[1114px]">
              <h2 className="font-bold text-white text-[28px] sm:text-[32px] md:text-[48px] leading-tight text-center">
            ...
            <div className="mt-6">
              <Button className="bg-[#00b6ff] text-white font-['Inter',Helvetica] font-medium text-sm sm:text-base md:text-lg px-6 py-2 shadow-[0px_21px_8px_#63636303,0px_12px_7px_#63636308,0px_5px_5px_#6363630f,0px_1px_3px_#63636312]">
                Try Now
              </Button>
            </div>
          </div>
