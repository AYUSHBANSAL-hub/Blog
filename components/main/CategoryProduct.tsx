...
const CategoryProductSection = ({ onProductClick }: { onProductClick: (category: string) => void }) => {
  return (
    <section className="flex flex-col w-full items-center gap-3 py-6">
      ...
      <Button
        variant="outline"
        className="min-w-[250px] font-[500] mt-3 font-figtree text-[16px] max-w-[380px] min-h-12 px-[58.44px] py-[12px] rounded-full border border-[#5F6368] text-[#1A73E8] hover:bg-[#f1f3f4]"
      >
        Load more Category
      </Button>
    </section>
