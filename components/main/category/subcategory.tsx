...
const SubcategoryList = ({
  ...
  const handleShowLess = () => setVisibleCount(ITEMS_PER_PAGE);
          ...
          {loading
            ...
            : visibleSubcategories.map((subcategory: any, index: number) => (
                ...
                >
                  ...
                  >
                    <p className="text-[#1A73E8] cursor-default text-[14px] font-[500] uppercase leading-[48px] tracking-[0.25px]">
                      {subcategory.subcategory_name}
                    </p>
                    <p className="text-[#202124] line-clamp-2 cursor-default w-[330px] text-[20px] font-[400] leading-[1.4]">
